...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sepLine2.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.sepLine2.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        ...
        self.actionRun_VMD_contact_search = QtGui.QAction(MainWindow)
        ...
        self.actionExportData.setShortcutContext(QtCore.Qt.ShortcutContext.WindowShortcut)
        self.actionExportData.setObjectName("actionExportData")
        self.actionContact_Area_Calculations = QtGui.QAction(MainWindow)
        self.actionContact_Area_Calculations.setObjectName("actionContact_Area_Calculations")
        self.actionPreferences = QtGui.QAction(MainWindow)
        self.actionPreferences.setObjectName("actionPreferences")
        self.actionVMD_Remote_Control = QtGui.QAction(MainWindow)
        self.actionVMD_Remote_Control.setObjectName("actionVMD_Remote_Control")
        self.actionTrack_Molecule = QtGui.QAction(MainWindow)
